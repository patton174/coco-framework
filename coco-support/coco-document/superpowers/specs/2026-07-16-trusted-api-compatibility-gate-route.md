...
- `japicmp-policy.json` schema v3 同时固定 finding key/categories/scopes、API checker 使用的 `mavenPlugin` 和 shadow 使用的 `cli`。Maven plugin 固定 size `44670` 与 SHA-256 `7df259e8be0c652259ef96416fcc6f2e7ef5e5a340a4df52783350abcd77c4bb`；CLI fat JAR 固定 size `5988558` 与 SHA-256 `f2300a8531b68e25b678247874a1eae13a07d6842a4a1236845481fc90c5c6c7`；两者 URL 均只能是精确 `repo.maven.apache.org` 路径；
