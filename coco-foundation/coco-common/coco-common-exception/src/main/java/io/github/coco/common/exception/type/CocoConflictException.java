 ...
 * Coco 资源冲突异常。
 * <p>
 * 表示请求与当前资源状态冲突，例如唯一键重复、版本冲突或重复提交。
 * </p>
 * <p>
 * 项目信息：
 * </p>
 ...
 * @since 1.0.0
 */
public class CocoConflictException extends CocoException {
     ...
     * @param args 消息格式化参数
     */
    public CocoConflictException(CocoBusinessCode businessCode, Object... args) {
        super(businessCode, args);
    }

    /**
     * <p>
     * 使用业务码契约和异常原因创建资源冲突异常。
     * </p>
     * @param businessCode 业务码契约
     * @param cause 异常原因
     * @param args 消息格式化参数
     */
    public CocoConflictException(CocoBusinessCode businessCode, Throwable cause, Object... args) {
        super(businessCode, cause, args);
    }

    /**
     * <p>
     * 使用消息编码、默认文本和格式化参数创建资源冲突异常。
     * </p>
     * @param code 消息编码
     * @param defaultMessage 默认消息文本
     * @param args 消息格式化参数
     */
    public CocoConflictException(String code, String defaultMessage, Object... args) {
        super(code, defaultMessage, args);
    }

    /**
     * <p>
     * 使用消息编码、默认文本、异常原因和格式化参数创建资源冲突异常。
     * </p>
     * @param code 消息编码
     * @param defaultMessage 默认消息文本
     * @param cause 异常原因
     * @param args 消息格式化参数
     */
    public CocoConflictException(String code, String defaultMessage, Throwable cause, Object... args) {
