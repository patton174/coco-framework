...
public final class StandardCocoFeatures {
    ...
    private static final List<CocoFeatureDefinition> FEATURES = List.of(
            ...
            feature(CocoFeature.RATE_LIMIT, "coco-rate-limit",
                    "io.github.coco.feature.ratelimit.CocoRateLimitAutoConfiguration",
                    CocoFeature.WEB),
            ...
            feature(CocoFeature.LOCK, "coco-lock",
            ...
            feature(CocoFeature.CACHE, "coco-cache",
