...
import io.github.coco.security.context.HolderCocoSecurityContextResolver;
import io.github.coco.security.web.CocoSecurityWebFilter;
import io.github.coco.security.web.CocoWebSecurityContextResolver;
import io.github.coco.security.web.HeaderCocoWebSecurityContextResolver;
...
public class CocoSecurityAutoConfiguration {
    ...
    public CocoMessageBundleRegistrar cocoSecurityMessageBundleRegistrar() {
        return registry -> registry.add("coco-security-messages");
    }
