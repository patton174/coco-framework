...
import io.github.coco.tenant.CocoTenantErrorCode;
...
public final class CocoTenantContextHolder {
    ...
    public static CocoContextSnapshot capture() {
        Optional<CocoTenantContext> captured = current();
        return () -> {
