...
import io.github.coco.openapi.springdoc.CocoSpringDocOpenApiCustomizerFactoryBean;
...
public class CocoOpenApiAutoConfiguration {
    ...
    public CocoMessageBundleRegistrar cocoOpenApiMessageBundleRegistrar() {
        return registry -> registry.add("coco-openapi-messages");
    }
    ...
    public CocoSpringDocOpenApiCustomizerFactoryBean cocoSpringDocOpenApiCustomizer(
            ObjectProvider<CocoOpenApiMetadataProvider> metadataProvider) {
