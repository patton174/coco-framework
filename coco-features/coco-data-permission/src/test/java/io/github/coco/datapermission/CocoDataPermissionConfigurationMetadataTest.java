...
class CocoDataPermissionConfigurationMetadataTest {
    ...
    void exposesSqlPropertyMetadata() throws IOException {
        ...
        assertProperty(metadata, "coco.data-permission.sql.missing-context-policy",
                "io.github.coco.datapermission.sql.CocoDataPermissionMissingContextPolicy");
        assertProperty(metadata, "coco.data-permission.sql.missing-rule-policy",
                "io.github.coco.datapermission.sql.CocoDataPermissionMissingRulePolicy");
        assertProperty(metadata, "coco.data-permission.sql.resources",
                "java.util.Map<java.lang.String,io.github.coco.datapermission.sql.CocoDataPermissionSqlResourceProperties>");
        assertProperty(metadata, "coco.data-permission.sql.resources.*.column-type",
                "io.github.coco.datapermission.sql.CocoDataPermissionSqlColumnType");
