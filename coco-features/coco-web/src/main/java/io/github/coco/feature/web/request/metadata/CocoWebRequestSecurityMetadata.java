...
/**
 * Coco Web 请求安全元数据�? * <p>
 * 保存 Sign、AES 和后续防重放能力共享的请求身份、时间戳、随机串、算法和加密标记等协议材料�? * </p>
 * <p>
 * 项目信息�? * </p>
 * <ul>
 ...
 * @param signatureTimestamp 签名时间�? * @param signatureNonce 签名随机�? * @param signatureAlgorithm 签名算法
 ...
 * @param encrypted 请求是否声明为加密请�? * @param replayAppId 防重放应用标�? * @param replayKeyId 防重放密钥标�? * @param replayTimestamp 防重放时间戳
...
public record CocoWebRequestSecurityMetadata(String signatureAppId, String signatureKeyId,
     ...
     * <p>
     * 返回请求是否携带防重放材料�?     * </p>
     * @return 请求携带防重放时间戳或随机串时返�?{@code true}
     */
