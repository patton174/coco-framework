...
/**
 * Coco Web 默认请求上下文解析器�? * <p>
 * 解析客户�?IP、请求头、请求参数、查询字符串、语言、协议、主机和内容类型，并对敏感字段做统一清洗�? * </p>
 * <p>
 * 项目信息�? * </p>
 * <ul>
...
public final class DefaultCocoWebRequestContextResolver implements CocoWebRequestContextResolver {
     ...
     * <p>
     * 创建默认请求上下文解析器�?     * </p>
     * @param properties Web 请求上下文配�?     * @param browserFingerprintResolver 浏览器指纹解析器
     */
    public DefaultCocoWebRequestContextResolver(CocoWebContextProperties properties,
     ...
     * <p>
     * 创建默认请求上下文解析器�?     * </p>
     * @param properties Web 请求上下文配�?     * @param clientIpResolver 客户�?IP 解析�?     * @param browserFingerprintResolver 浏览器指纹解析器
     */
    public DefaultCocoWebRequestContextResolver(CocoWebContextProperties properties,
     ...
     * @param properties Web 请求上下文配�?     * @param clientIpResolver 客户�?IP 解析�?     * @param browserFingerprintResolver 浏览器指纹解析器
     * @param requestHeaderResolver 请求头解析器
     * @param requestParameterResolver 请求参数解析�?     * @param securityInputResolver 请求安全输入解析�?     */
    public DefaultCocoWebRequestContextResolver(CocoWebContextProperties properties,
            CocoClientIpResolver clientIpResolver,
            CocoBrowserFingerprintResolver browserFingerprintResolver, CocoRequestHeaderResolver requestHeaderResolver,
            CocoRequestParameterResolver requestParameterResolver,
     ...
     * @param properties Web 请求上下文配�?     * @param clientIpResolver 客户�?IP 解析�?     * @param browserFingerprintResolver 浏览器指纹解析器
     * @param requestHeaderResolver 请求头解析器
     * @param requestParameterResolver 请求参数解析�?     * @param securityInputResolver 请求安全输入解析�?     * @param securityMetadataResolver 请求安全元数据解析器
     */
    public DefaultCocoWebRequestContextResolver(CocoWebContextProperties properties,
            CocoClientIpResolver clientIpResolver,
            CocoBrowserFingerprintResolver browserFingerprintResolver, CocoRequestHeaderResolver requestHeaderResolver,
     ...
     * @param properties Web 请求上下文配�?     * @param clientIpResolver 客户�?IP 解析�?     * @param browserFingerprintResolver 浏览器指纹解析器
     * @param requestHeaderResolver 请求头解析器
     * @param requestCookieResolver Cookie 解析�?     * @param requestTargetResolver Web 请求目标解析�?     * @param requestParameterResolver 请求参数解析�?     * @param securityInputResolver 请求安全输入解析�?     * @param securityMetadataResolver 请求安全元数据解析器
     */
    public DefaultCocoWebRequestContextResolver(CocoWebContextProperties properties,
            CocoClientIpResolver clientIpResolver,
            CocoBrowserFingerprintResolver browserFingerprintResolver, CocoRequestHeaderResolver requestHeaderResolver,
