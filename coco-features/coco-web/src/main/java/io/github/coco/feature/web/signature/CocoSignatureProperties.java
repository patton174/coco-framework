...
/**
 * Coco 请求签名配置属性�? * <p>
 * 控制 Sign 验签设施的启用策略、请求头名称、时间戳容忍窗口和本地密钥映射�? * </p>
 * <p>
 * 项目信息�? * </p>
 * <ul>
...
public class CocoSignatureProperties {
     ...
     * <p>
     * 设置签名请求是否必须携带时间戳�?     * </p>
     * @param timestampRequired 是否必须携带时间�?     */
     ...
     * <p>
     * 设置是否校验签名时间戳窗口�?     * </p>
     * @param timestampValidationEnabled 是否校验时间戳窗�?     */
    ...
    /**
     * <p>
     * 设置允许的客户端和服务端时间差，单位秒�?     * </p>
     * @param maxClockSkewSeconds 时间戳容忍窗口秒�?     */
     ...
     * <p>
     * 设置时间戳请求参数名称�?     * </p>
     * @param timestampParameterName 时间戳请求参数名�?     */
     ...
     * <p>
     * 设置随机串请求参数名称�?     * </p>
     * @param nonceParameterName 随机串请求参数名�?     */
     ...
     * <p>
     * 设置签名请求头名称�?     * </p>
     * @param signatureHeaderName 签名请求头名�?     */
     ...
     * <p>
     * 设置签名兜底请求头名称�?     * </p>
     * @param signatureFallbackHeaderName 签名兜底请求头名�?     */
     ...
     * <p>
     * 设置签名算法请求头名称�?     * </p>
     * @param algorithmHeaderName 签名算法请求头名�?     */
