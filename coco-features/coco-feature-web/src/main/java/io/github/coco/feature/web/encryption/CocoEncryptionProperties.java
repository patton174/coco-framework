 ...
 * Coco 请求加密配置属性。
 * <p>
 * 控制 AES 解密设施的启用策略、请求头名称、密钥编码、IV 编码、密文编码和本地密钥映射。
 * </p>
 * <p>
 * 项目信息：
 * </p>
...
public class CocoEncryptionProperties {
     ...
     * 设置加密标记请求头名称。
     * </p>
     * @param encryptedHeaderName 加密标记请求头名称
     */
     ...
     * 设置算法请求头名称。
     * </p>
     * @param algorithmHeaderName 算法请求头名称
     */
     ...
     * 设置密文请求体文本编码。
     * </p>
     * @param payloadEncoding 密文请求体文本编码
     */
