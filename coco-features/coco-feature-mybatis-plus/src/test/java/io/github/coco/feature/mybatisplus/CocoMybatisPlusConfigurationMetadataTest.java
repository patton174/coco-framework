...
class CocoMybatisPlusConfigurationMetadataTest {
    ...
    void exposesPaginationPropertyMetadata() throws IOException {
        ...
        assertTrue(content.contains("\"name\": \"coco.mybatis-plus.pagination.enabled\""));
        assertTrue(content.contains("\"name\": \"coco.mybatis-plus.pagination.db-type\""));
        assertTrue(content.contains("\"name\": \"coco.mybatis-plus.pagination.max-limit\""));
    }
}
