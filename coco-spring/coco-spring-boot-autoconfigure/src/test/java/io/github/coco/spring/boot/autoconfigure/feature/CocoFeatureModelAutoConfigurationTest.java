 ...
 * @since 1.0.0
 */
class CocoFeatureModelAutoConfigurationTest {

    private final ApplicationContextRunner contextRunner = new ApplicationContextRunner()
            .withConfiguration(AutoConfigurations.of(
                    CocoI18nAutoConfiguration.class,
                    CocoFeatureModelAutoConfiguration.class))
    ...
    void registersFeatureRegistryMessageBundle() {
        this.contextRunner.run(context -> {
            ...
            assertTrue(context.containsBean("cocoFeatureModelMessageBundleRegistrar"));
            assertEquals("未找到 Coco 功能定义。", messageService.getMessage("coco.feature.model.not-found"));
        });
    }
}
