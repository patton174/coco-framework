...
public class CocoFeaturePlanAutoConfiguration {

    private static final Log LOGGER = LogFactory.getLog(CocoFeaturePlanAutoConfiguration.class);
    ...
    public CocoMessageBundleRegistrar cocoConfigMessageBundleRegistrar() {
        return registry -> registry.add("coco-spring-boot-feature-messages");
    }
