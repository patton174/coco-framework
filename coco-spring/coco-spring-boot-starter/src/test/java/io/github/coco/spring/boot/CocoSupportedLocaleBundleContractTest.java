...
class CocoSupportedLocaleBundleContractTest {
    ...
    private static final Map<String, String> REPRESENTATIVE_MESSAGES = Map.of(
            "coco-feature-audit-messages", "coco.feature.audit.ready",
            "coco-feature-tenant-messages", "coco.feature.tenant.ready",
            "coco-feature-mybatis-plus-messages", "coco.feature.mybatis-plus.ready",
            "coco-feature-openapi-messages", "coco.feature.openapi.ready",
            "coco-feature-codegen-messages", "coco.feature.codegen.ready",
            "coco-feature-data-permission-messages", "coco.feature.data-permission.ready",
            "coco-feature-registry-messages", "coco.feature.registry.not-found",
            "coco-feature-runtime-messages", "coco.feature.runtime.ready");
