...
**Goal:** Add a `coco-common` module that provides Coco framework infrastructure for i18n messages, framework prompts, and framework exceptions.

**Architecture:** `coco-common` is a reusable infrastructure module consumed by `coco-spring-boot-starter`. Public APIs live in `io.github.coco.common.i18n` and `io.github.coco.common.exception`; Spring Boot wiring lives in `io.github.coco.common.autoconfigure`. Message text is resolved through a Coco-owned `MessageSource`, while exceptions and prompts carry code, args, and default text without resolving locale too early.
...
- Add `coco-common`; do not create `coco-base` or `coco-i18n`.
...
- `coco-common` must not depend on `coco-config`.
...
**Interfaces:**
- Produces Maven artifact `io.github.patton174:coco-common`.
- Produces starter dependency on `coco-common`.

- [ ] Add `<module>coco-common</module>` to the root reactor after `coco-api` and before feature/starter modules.
- [ ] Add `coco-common` to root dependency management.
- [ ] Add `coco-common` to `coco-bom` dependency management.
- [ ] Add `coco-common` as a dependency of `coco-spring-boot-starter`.
- [ ] Create `coco-common/pom.xml` with dependencies on `coco-api`, `spring-context`, `spring-boot`, `spring-boot-autoconfigure`, optional `spring-boot-configuration-processor`, and test dependencies `spring-boot-test`, `assertj-core`, `junit-jupiter`.
- [ ] Run `mvn -pl coco-common -am test`; expected result is success if the empty module compiles.

### Task 2: Implement Framework Message And Exception Contracts

**Files:**
- Create: `coco-common/src/test/java/io/github/coco/common/i18n/CocoMessageTest.java`
- Create: `coco-common/src/test/java/io/github/coco/common/exception/CocoExceptionTest.java`
- Create: `coco-common/src/main/java/io/github/coco/common/i18n/CocoMessage.java`
- Create: `coco-common/src/main/java/io/github/coco/common/exception/CocoException.java`
...
- [ ] Run `mvn -pl coco-common -am test`; expected RED with missing classes.
...
- [ ] Run `mvn -pl coco-common -am test`; expected GREEN for contract tests.

### Task 3: Implement I18n Service And Properties

**Files:**
- Create: `coco-common/src/test/java/io/github/coco/common/i18n/DefaultCocoMessageServiceTest.java`
- Create: `coco-common/src/main/java/io/github/coco/common/CocoCommonProperties.java`
- Create: `coco-common/src/main/java/io/github/coco/common/i18n/CocoI18nProperties.java`
- Create: `coco-common/src/main/java/io/github/coco/common/i18n/CocoLocaleResolver.java`
- Create: `coco-common/src/main/java/io/github/coco/common/i18n/DefaultCocoLocaleResolver.java`
- Create: `coco-common/src/main/java/io/github/coco/common/i18n/CocoMessageService.java`
- Create: `coco-common/src/main/java/io/github/coco/common/i18n/DefaultCocoMessageService.java`
- Create: `coco-common/src/test/resources/messages_zh_CN.properties`
- Create: `coco-common/src/test/resources/messages_en_US.properties`
...
- [ ] Run `mvn -pl coco-common -am test`; expected RED with missing service/properties classes.
...
- [ ] Run `mvn -pl coco-common -am test`; expected GREEN for service tests.

### Task 4: Implement Spring Boot Auto-Configuration And Metadata

**Files:**
- Create: `coco-common/src/test/java/io/github/coco/common/autoconfigure/CocoCommonAutoConfigurationTest.java`
- Create: `coco-common/src/test/java/io/github/coco/common/CocoCommonConfigurationMetadataTest.java`
- Create: `coco-common/src/main/java/io/github/coco/common/autoconfigure/CocoCommonAutoConfiguration.java`
- Create: `coco-common/src/main/resources/META-INF/spring/org.springframework.boot.autoconfigure.AutoConfiguration.imports`
- Create: `coco-common/src/main/resources/coco-messages.properties`
- Create: `coco-common/src/main/resources/coco-messages_zh_CN.properties`
- Create: `coco-common/src/main/resources/coco-messages_en_US.properties`
...
- [ ] Run `mvn -pl coco-common -am test`; expected RED with missing auto-configuration.
...
- [ ] Run `mvn -pl coco-common -am test`; expected GREEN.
...
- Type consistency: property namespace is `coco.common.i18n`; module is `coco-common`; public packages use `io.github.coco.common`.
